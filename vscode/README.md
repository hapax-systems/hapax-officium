...
| [hapax-officium](https://github.com/hapax-systems/hapax-officium) | Tier 2 agent implementations + logos API |
| [hapax-council](https://github.com/hapax-systems/hapax-council) | Personal operating environment (logos API on :8051) |
